...
<html lang="en">
	...
	<body>
		...
		<div id="page" class="page font--jakarta">
			...
			<header id="header" class="tra-menu navbar-dark white-scroll">
				<div class="header-wrapper">
				    ...
				    <div class="wsmobileheader clearfix">
				    	<span class="smllogo"><img src="imgs/logo-sem-fundo.png" alt="mobile-logo"></span>
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						<a href="#hero-22" class="logo-black"><img src="imgs/logo-sem-fundo.png" alt="logo"></a>
	    					</div>


	    					<!-- HEADER WHITE LOGO -->
	    					<div class="desktoplogo">
	    						<a href="#hero-22" class="logo-white"><img src="images/logo-blue-white.png" alt="logo"></a>
	    					</div>
	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list nav-theme">
	             							...
	             							<div class="container">
									               ...
									               <!-- MEGAMENU LINKS -->
	               									<ul class="col-md-12 col-lg-3 link-list">
									                    ...
									                    <li><a href="login-2.blade.php">Login Page</a></li>
							    	...
							    	<li class="nl-simple reg-fst-link mobile-last-link" aria-haspopup="true">
							    		<a href="login-2.blade.php" class="h-link">Sign in</a>
							    	</li>
			...
			<!-- HERO-22
			============================================= -->
			<section id="hero-22" class="bg--fixed hero-section">
				<div class="container">
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 col-lg-5 offset-md-6 offset-lg-7">
							<div id="hero-22-form" class="r-10 wow fadeInLeft">
								...
								<!-- Hero Logo  -->
								<div class="hero-logo">
									<img class="img-fluid" src="imgs/logo-sem-fundo.png" alt="hero-logo">
								</div>
								...
								<!-- Text -->
								<p class="p-md color--grey">Get started with Martex for free. It's fast and very easy! No credit card needed
								</p>
				...
				<div class="wave-shape-bottom">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 265"><path fill-opacity="1" d="M0,256L120,256C240,256,480,256,720,240C960,224,1200,192,1320,176L1440,160L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path></svg>
				</div>
							...
							<div class="row d-flex align-items-center">
								...
								<div class="col-md-6 order-last order-md-2">
									<div class="txt-block left-column wow fadeInRight">
										...
										<!-- Text -->
										<p>Sodales tempor sapien quaerat congue eget ipsum laoreet turpis neque auctor vitae
											eros dolor luctus placerat magna ligula cursus and purus pretium
										</p>
						...
						<div class="col-md-6">
							<div class="txt-block right-column wow fadeInLeft">
								...
								<div class="txt-block-tra-link mt-25">
									<a href="#features-12" class="tra-link ico-20 color--theme">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 order-last order-md-2">
							<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Link -->
								<div class="txt-block-tra-link mt-25">
									<a href="#integrations-2" class="tra-link ico-20 color--theme">
										Explore all integrations <span class="flaticon-next"></span>
									</a>
								</div>
				...
				<div class="container">
					...
					<div class="fbox-wrapper text-center">
						<div class="row d-flex align-items-center">
							...
							<!-- FEATURE BOX #1 -->
							<div class="col-md-6">
								<div class="fbox-5 fb-1 bg--02 r-16 wow fadeInUp">

									<!-- Text -->
									<div class="fbox-txt order-last order-md-2">
										<h5 class="s-26 w-700">Multiple Accounts</h5>
									...
									<div class="fbox-5-img order-first order-md-2">
										<img class="img-fluid" src="images/f_11.png" alt="feature-image">
									</div>
		 					...
		 					<!-- FEATURE BOX #2 -->
							<div class="col-md-6">
								<div class="fbox-5 fb-2 bg--02 r-16 wow fadeInUp">
			...
			<!-- IMAGE CONTENT
			============================================= -->
			<section id="lnk-3" class="pt-100 ct-08 content-section division">
				<div class="container">
					...
					<div class="row">
						<div class="col">
							<div class="img-block video-preview wow fadeInUp">
								...
								<!-- Preview Image -->
			 					<img class="img-fluid" src="images/dashboard-02.png" alt="video-preview">
			...
			<!-- BRANDS-1
			============================================= -->
			<div id="brands-1" class="pt-90 pb-100 brands-section">
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-md-10 col-lg-9">
							<div class="brands-title mb-50">
								<h5 class="s-19 w-700">Over 100 companies sign up Martex every day!</h5>
							</div>
						</div>
					</div>
						...
						<!-- TEXT BLOCK -->
			 			<div class="col-md-6 col-lg-5 order-last order-md-2">
			 				<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Link -->
								<div class="txt-block-tra-link mt-25">
									<a href="#lnk-4" class="tra-link ico-20 color--theme">
										Marketing Integrations <span class="flaticon-next"></span>
									</a>
								</div>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6">
							<div class="txt-block right-column wow fadeInLeft">
								...
								<!-- Title -->
								<h2 class="s-46 w-700">Simplify your work, amplify productivity</h2>
								...
								<div class="review-1 bg--white-100 block-shadow r-08">
									...
									<div class="review-txt">
										...
										<p>Mauris donec a magnis sapien etiam pretium a congue augue volutpat lectus aenean
										   magna and undo mauris lectus laoreet tempor egestas rutrum
										</p>
			...
			<!-- TEXT CONTENT
			============================================= -->
			<section id="lnk-4" class="pt-100 ct-13 content-section division">
				<div class="container">
					...
					<div class="row mb-60">
						...
						<div class="col-md-6 order-first order-md-2">
							<div class="img-block right-column wow fadeInLeft">
								<img class="img-fluid" src="images/img-01.png" alt="content-image">
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="txt-block left-column wow fadeInRight">
								...
								<!-- Text -->
								<p class="mb-0">Tempor sodales sapien quaerat ipsum undo congue laoreet turpis neque
			...
			<section id="banner-13" class="pt-100 banner-section">
				<div class="container">
					...
					<!-- BANNER-13 WRAPPER -->
					<div class="banner-13-wrapper bg--04 bg--scroll r-16 block-shadow">
                            ...
                            <div class="overlay-light">
                                <div class="modal-img text-center">
                                	<a href="pricing-1.html">
                                		<img class="img-fluid" src="images/modal-1-img.jpg" alt="modal-image">
                                	</a>
                                </div>
                            </div>
					...
					<div class="row">
						...
						<div class="col-xl-3">
							<div class="footer-info">
								<img class="footer-logo" src="imgs/logo-sem-fundo.png" alt="footer-logo">
							</div>
						</div>
