...
<html lang="en">
	...
	<body>
		...
		<div id="page" class="page font--jakarta">
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						<a href="#hero-8" class="logo-black"><img src="images/logo-blue.png" alt="logo"></a>
	    					</div>


	    					<!-- HEADER WHITE LOGO -->
	    					<div class="desktoplogo">
	    						<a href="#hero-8" class="logo-white"><img src="images/logo-white.png" alt="logo"></a>
	    					</div>
	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list nav-theme">
								    ...
								    <li class="nl-simple" aria-haspopup="true">
								    	<a href="signup-2.html" class="btn r-04 btn--tra-white hover--theme last-link">Sign up</a>
								    </li>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-6 col-lg-7">
							<div class="hero-8-txt color--white wow fadeInRight">
								...
								<!-- Text -->
								<p class="p-lg color--coal">Mauris donec turpis suscipit sapien ociis sagittis sapien
								...
								<div class="hero-digits clearfix">
									...
									<div id="hd-1-1">
										<div class="hero-digits-block">
											...
											<!-- Text -->
											<div class="block-txt">
												<p class="p-sm 1color--coal">Tempor sapien and quaerat placerat</p>
											</div>
									...
									<div id="hd-1-2">
										<div class="hero-digits-block">
											...
											<!-- Text -->
											<div class="block-txt">
												<p class="p-sm 1color--coal">Ligula suscipit vitae and rutrum turpis</p>
											</div>
						...
						<div class="col-md-6 col-lg-5">
							<div id="hero-8-form" class="r-10 wow fadeInLeft">
								...
								<!-- Text -->
								<p class="p-md">Feugiat primis ligula risus auctor purus laoreet augue mauris viverra tortor</p>
					            ...
					            <!-- Notice Text -->
					            <p class="p-sm">By submitting this form, you accept our <a href="terms.html">Terms of Service</a>
			...
			<!-- BRANDS-1
			============================================= -->
			<div id="brands-1" class="pt-80 pb-90 bottom-border brands-section">
				<div class="container">
								...
								<div class="col-md-6 order-last order-md-2">
									<div class="txt-block left-column wow fadeInRight">
										...
										<div class="txt-block-tra-link mt-25">
											<a href="#features-6" class="tra-link ico-20 color--theme">
						...
						<div class="row">
							<div class="col">
								<div class="img-block video-preview wow fadeInUp">
									...
									<!-- Preview Image -->
				 					<img class="img-fluid" src="images/dashboard-06.png" alt="video-preview">
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-md-6">
								<div class="fbox-5 fb-1 gr--smoke r-16 wow fadeInUp">
									...
									<div class="fbox-txt order-last order-md-2">
										<h5 class="s-26 w-700">Improved Productivity</h5>
							...
							<div class="col-md-6">
								<div class="fbox-5 fb-2 gr--smoke r-16 wow fadeInUp">
									...
									<!-- Text -->
									<div class="fbox-txt">
										<h5 class="s-26 w-700">Advanced Analytics</h5>
										<p>Aliquam a augue suscipit luctus diam neque purus ipsum neque and dolor primis libero</p>
									</div>
			...
			<!-- TEXT CONTENT
			============================================= -->
			<section class="py-100 ct-04 content-section division">
				<div class="container">
			...
			<section id="banner-13" class="pt-100 banner-section">
				<div class="container">
					...
					<!-- BANNER-13 WRAPPER -->
					<div class="banner-13-wrapper bg--01 bg--scroll r-16 block-shadow">
							...
							<div class="row d-flex align-items-center">
								...
								<div class="col-md-7">
									<div class="banner-13-txt color--white">
										...
										<!-- Button -->
										<a href="#hero-8" class="btn r-04 btn--theme hover--tra-white">Get srarted - it's free</a>
